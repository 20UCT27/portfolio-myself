...
import './EMSscreen.css';
import addpage from '../assets/screenshots/addpage.png';
import listpage from '../assets/screenshots/listpage.png';
import editpage from '../assets/screenshots/editpage.png';
import deletepage from '../assets/screenshots/deletepage.png';
...
function EMSscreen(){
    return(
        ...
        <div className="col-lg-6 col-md-12 col-sm-12">
          <img src={editpage} alt="" />
          <img src={deletepage} alt="" />
        </div>
      </div>
      <div className="back">
